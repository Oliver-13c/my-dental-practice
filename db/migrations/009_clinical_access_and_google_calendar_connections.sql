-- Migration: 009_clinical_access_and_google_calendar_connections.sql
-- Purpose:
...
-- ── Provider-owned Google Calendar connections ──────────────────────────────
...
-- ── Appointments: dentists/hygienists only see assigned appointments ────────
...
-- ── Patients: clinical staff can only view patients assigned to them ─────────
...
-- ── Intake submissions: clinical staff only for assigned patients ────────────
